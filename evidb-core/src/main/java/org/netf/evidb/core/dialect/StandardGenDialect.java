 ...
 */
package org.netf.evidb.core.dialect;
...
import org.netf.evidb.core.constants.ClassConstants;
import org.netf.evidb.core.exception.ApplicationException;
import org.netf.evidb.core.meta.ColumnMeta;
import org.netf.evidb.core.util.TableUtil;
 ...
 *
 */
public abstract class StandardGenDialect implements Dialect {
	...
	public void replacePropertyClassName(String oldClassName, String newClassName) {
		...
		if (oldClassName == null) {
			throw new ApplicationException("oldClassName");
		}

		if (newClassName == null) {
			throw new ApplicationException("newClassName");
		}
